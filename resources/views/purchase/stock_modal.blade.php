        ...
        <div class="p-5 space-y-3">
            ...
            <div id="modalContent" class="hidden space-y-3">
                ...
                <div class="flex items-center justify-between rounded-lg bg-blue-50 px-4 py-3 dark:bg-blue-500/10">
                    <span class="text-sm text-blue-700 dark:text-blue-400">Total Stock</span>
                    <span id="modalTotalStockFromMaterial" class="text-sm font-semibold text-blue-700 dark:text-blue-400"></span>
                </div>
                <div class="flex items-center justify-between rounded-lg bg-blue-50 px-4 py-3 dark:bg-blue-500/10">

    ...
    <div class="col-span-12 space-y-6 xl:col-span-12">
        ...
        <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between px-3">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">All material purchase records</p>
            </div>
            ...
            <div class="mb-4 flex flex-col gap-3 px-5 sm:flex-row sm:items-center sm:justify-between sm:px-6">
                ...
                <form method="GET" action="{{ route('purchases.index') }}">
                    <div class="flex items-center gap-2">
                        ...
                        <x-search-input placeholder="Search purchases..."/>
                        ...
                        <button type="submit"
                            ...
                            <svg class="fill-white" width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">

...
@section('content')
    ...
    <div class="col-span-12 space-y-6 xl:col-span-12">
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    setTimeout(() => {
                        Swal.fire({
                            ...
                            didOpen: (toast) => {
                                toast.parentNode.style.zIndex =
                                99999; // ensure parent container is on top
                            },
                            customClass: {
                                popup: 'z-[99999]'
                            }
        ...
        <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between px-3">
            <div>
                <h2 class="text-2xl font-semibold text-gray-800 dark:text-white/90">Suppliers</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Manage your supplier directory</p>
            </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="mb-4 flex flex-col gap-3 px-5 sm:flex-row sm:items-center sm:justify-between sm:px-6">
                <div>
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">All Suppliers</h3>
                    ...
                    <thead class="border-y border-gray-100 py-3 dark:border-gray-800">
                        <tr>
                            ...
                            <th class="py-3 px-4 font-normal whitespace-nowrap text-left">
                                <p class="text-theme-sm text-gray-500 dark:text-gray-400">Supplier Name</p>
                            </th>
                            <th class="py-3 px-4 font-normal whitespace-nowrap text-left">
                                    ...
                                    <div class="inline-flex items-center gap-1 ">
                                        ...
                                        {{-- <form action="{{ route('suppliers.destroy', $supplier->id) }}" method="POST"
                                            ...
                                            <button type="submit" title="Delete"
                                                class="inline-flex items-center justify-center w-8 h-8 rounded-lg text-gray-500 hover:text-error-500 hover:bg-error-50 dark:text-gray-400 dark:hover:text-error-400 dark:hover:bg-error-500/10 transition-colors">
                                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24"
                                                    stroke="currentColor" stroke-width="2">
                            ...
                            @foreach ($suppliers->getUrlRange(max(1, $suppliers->currentPage() - 2), min($suppliers->lastPage(), $suppliers->currentPage() + 2)) as $page => $url)
                                <li>
                                    @if ($page == $suppliers->currentPage())
                                        <span
                                            class="bg-brand-500/[0.08] text-theme-sm text-brand-500 flex h-10 w-10 items-center justify-center rounded-lg font-medium">
                                            {{ $page }}
                                        </span>
                                    @else
                                        <a href="{{ $url }}"

...
@section('content')
                    ...
                    <div class="border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="bricks_produced" value="{{ old('bricks_produced', $batch?->bricks_produced ?? '') }}"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="bricks_wasted" value="{{ old('bricks_produced', $batch->bricks_produced ?? '') }}"
                    ...
                    <div class="border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="labor_cost" id="labor_cost"
                                        value="{{ old('labor_cost') }}" placeholder="e.g. 5000.00" min="0"
                                        step="any" @class([
                                            'dark:bg-dark-900 shadow-theme-xs w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:text-white/90 dark:placeholder:text-white/30',
                                            'border-error-300 focus:border-error-300 focus:ring-error-500/10 dark:border-error-700 dark:focus:border-error-800 pr-10' => $errors->has(
                                                'labor_cost'),
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="fuel_cost" id="fuel_cost"
                                        value="{{ old('fuel_cost', $batch?->fuel_cost ?? '') }}" placeholder="e.g. 3000.00" min="0"
                                        step="any" @class([
                                            'dark:bg-dark-900 shadow-theme-xs w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:text-white/90 dark:placeholder:text-white/30',
                                            'border-error-300 focus:border-error-300 focus:ring-error-500/10 dark:border-error-700 dark:focus:border-error-800 pr-10' => $errors->has(
                                                'fuel_cost'),
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="other_cost" id="other_cost"
                                        value="{{ old('other_cost', $batch?->other_cost ?? 0) }}" placeholder="e.g. 500.00" min="0"
                                        step="any" @class([
                                            'dark:bg-dark-900 shadow-theme-xs w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:text-white/90 dark:placeholder:text-white/30',
                                            'border-error-300 focus:border-error-300 focus:ring-error-500/10 dark:border-error-700 dark:focus:border-error-800 pr-10' => $errors->has(
                                                'other_cost'),
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="other_cost_note" value="{{ old('other_cost_note', $batch?->other_cost_note ?? '') }}"
    ...
    <script>
        ...
        `;
            ...
            row.querySelector('.rate').addEventListener('input', () => recalcRow(row));
        ...
        // wire labor/fuel to grand total recalc
        ...
        @if (old('materials'))
            ...
            @endforeach
        @elseif(@$batch?->materials->isNotEmpty())

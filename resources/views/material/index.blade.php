...
@section('content')
    <div class="col-span-12 space-y-6 xl:col-span-12">
        ...
        <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between px-3">
            <div>
                <h2 class="text-2xl font-semibold text-gray-800 dark:text-white/90">Materials</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Manage raw material inventory</p>
            </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="mb-4 flex flex-col gap-3 px-5 sm:flex-row sm:items-center sm:justify-between sm:px-6">
                <div>
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">All Materials</h3>
                    <p class="mt-0.5 text-theme-xs text-gray-500 dark:text-gray-400">
                        {{ $materials->total() }} material{{ $materials->total() !== 1 ? 's' : '' }} found
                    </p>
                </div>
                ...
                <table class="min-w-full">
                    ...
                    <thead class="border-y border-gray-100 py-3">
                        <tr>
                            ...
                            <th class="py-3 px-4 text-left text-theme-sm text-gray-500">Unit</th>
                            <th class="py-3 px-4 text-left text-theme-sm text-gray-500">Stock Quantity</th>
                            <th class="py-3 px-4 text-left text-theme-sm text-gray-500">Avg Rate</th>
                        ...
                        @forelse($materials as $index => $material)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="py-3 px-4 font-medium text-green-600">
                                    Rs {{ number_format($material->avg_rate, 2) }}
                                </td>

                                <td class="px-5 py-4 text-center">
                                    <div class="inline-flex items-center gap-1">
                                        <a href="{{ route('materials.edit', $material->id) }}" title="Edit"

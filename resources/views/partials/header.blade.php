  ...
  >
    ...
    >
      ...
      <a href="index.html" class="lg:hidden">
        <img class="dark:hidden" src="
        {{ asset('admin_assets/css/style.css') }}/images/logo/logo.svg" alt="Logo" />
        <img
          class="hidden dark:block"
          src="
          {{ asset('admin_assets/css/style.css') }}/images/logo/logo-dark.svg"
          alt="Logo"
        />
      </a>
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="
                      {{ asset('admin_assets/css/style.css') }}/images/user/user-02.jpg"
                      alt="User"
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="
                      {{ asset('admin_assets/css/style.css') }}/images/user/user-03.jpg"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="
                      {{ asset('admin_assets/css/style.css') }}/images/user/user-04.jpg"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
              ...
              <li>
                ...
                >
                  ...
                  >
                    <img
                      src="
                      {{ asset('admin_assets/css/style.css') }}/images/user/user-05.jpg"
                      alt="User"
                      class="overflow-hidden rounded-full"
                    />
                    <span
      ...
      >
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
            <img src="
            {{ asset('admin_assets/css/style.css') }}/images/user/owner.jpg" alt="User" />
          </span>

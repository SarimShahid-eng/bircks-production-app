        ...
        <nav x-data="{ selected: '{{ $activeMenu }}' }">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <!-- Menu Item Ui Reports -->
                    <li>
                        <a href="#" @click.prevent="selected = (selected === 'Reports' ? '':'Reports')"
                            class="menu-item group @activeMenu('reports.*')">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="{{ route('reports.profit') }}"
                                        class="menu-dropdown-item group @menuDropdownItem('reports.profit')">
                                        Profit
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('reports.purchases') }}"
                                        class="menu-dropdown-item group @menuDropdownItem('reports.purchases')">
                                        Purchases
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('reports.sales') }}"
                                        class="menu-dropdown-item group @menuDropdownItem('reports.sales')">
                                        Sales
                                    </a>
                                </li>
